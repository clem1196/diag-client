      ...
      <div class="modal-content">
        <div class="modal-header mt-1">
          <div class="card card-title">
            <!--Title-->
            Crear Diagnosis
          </div> <button type="button" @click="props.closeFormCreate" class="btn-close" data-bs-dismiss="modal"
        ...
        <div class="modal-body">
          <form @submit.prevent="_createDiagnosis" @keyup="_validData">
            ...
            <footer class="modal-footer">
              ...
              <button @click="props.closeFormCreate" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
            </footer>
            <!--Messages-->
